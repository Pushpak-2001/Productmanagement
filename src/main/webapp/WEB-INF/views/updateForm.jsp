	...
	<div class="container mt-3">
		<div class="row">
			<div class="col-md-6 offset-md-3">
				...
				<form:form action="${pageContext.request.contextPath}/addProductSubmit" method="post"
					...
					<div class="form-group">
						<label for="name">Product Company</label> <input type="text"
							...
							placeholder="Enter the product company here" value="${product.productComp}">
					...
					<div class="form-group">
						<label for="name">Product Category</label> <input type="text"
							...
							placeholder="Enter the product category here" value="${product.productCategory}">
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="productDesc" rows="5"
							placeholder="Enter the product description">${product.productDesc}</textarea>
					...
					<div class="form-group">
						<label for="date">Start Date</label> <input class="form-control"
							...
							data-flatpickr data-date-format="d-m-Y" value="${product.startdt}">
					</div>

					<div class="form-group">
						<label for="date">End Date</label> <input class="form-control"
							name="enddt" type="date" placeholder="Select End Date"
							data-flatpickr data-date-format="d-m-Y" value="${product.enddt}">
					</div>
